...
**Recent Changes**: Disabled Twingate on omarchy VM (routing loop fix), PC heartbeat now routes through book5, n8n PC Health Monitor v2.1 with reboot limits and cooldown
**Nodes**:
